              ...
              <>
                ...
                {invoice.status !== "fully_paid" && (
                  <button
                    ...
                    className="mt-3 flex w-full items-center justify-center gap-1.5 rounded-2xl bg-primary/10 py-2.5 text-[11px] font-bold text-primary"
                  >
                    <IconRenderer name="money_outlined" className="size-3.5" /> تسجيل دفعة
                  </button>
                )}
