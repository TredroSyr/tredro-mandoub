...
const PRIMARY = "oklch(0.45 0.188 259.81)";
const PRIMARY_ACTIVE = "oklch(0.36 0.188 259.81)";
const PRIMARY_SOFT = "oklch(0.45 0.188 259.81 / 0.35)";
const PRIMARY_SHADOW = "oklch(0.45 0.188 259.81 / 0.45)";

const storeSvg = (active: boolean) => {
  const s = active ? 1.1 : 0.82;
  const fill = active ? PRIMARY_ACTIVE : PRIMARY;
  ...
  return `
    <div class="marker-pin" style="width:${38 * s}px;height:${46 * s}px;">
      <svg width="${38 * s}" height="${46 * s}" viewBox="0 0 38 46" fill="none">
        ...
        />
        <g transform="translate(9.5 9)" stroke="white" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" fill="none">
...
const truckSvg = (rotation: number) => {
  return `
    <div class="user-dot" style="position:relative;width:42px;height:42px;transform:rotate(${rotation}deg);">
      ...
      <span style="position:absolute;inset:7px;border-radius:9999px;background:${PRIMARY};border:3px solid white;box-shadow:0 6px 14px ${PRIMARY_SHADOW};display:grid;place-items:center;">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round" style="transform:rotate(-90deg)">
...
const flagSvg = `
  <div class="marker-pin" style="width:44px;height:44px;">
    <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
      <circle cx="22" cy="22" r="12" style="fill:${PRIMARY}" stroke="white" stroke-width="3" />
